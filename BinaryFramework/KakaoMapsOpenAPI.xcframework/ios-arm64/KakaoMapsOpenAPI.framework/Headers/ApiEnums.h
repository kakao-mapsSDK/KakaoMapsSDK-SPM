...
typedef NS_ENUM(NSInteger, PolylineCapType) {
    ...
    PolylineCapTypeButt,
    /// Polyline 끝지점에 Arrow형태의 Cap. 해당 타입 사용시 Polyline의 stroke는 3이하로 권장
    PolylineCapTypeArrow,
    /// Polyline 끝지점에 ArrowRound형태의 Cap. 해당 타입 사용시 Polyline의 stroke는 3이하로 권장
    PolylineCapTypeArrowRound
};
